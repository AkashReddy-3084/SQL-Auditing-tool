...
- Checklist definition (merged runtime file): `Backend/checklist/master-checklist.json`.
- Deterministic mapping (merged runtime file): `Backend/checklist/deterministic-script-mapping.json`.
