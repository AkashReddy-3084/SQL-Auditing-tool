    ...
    public class Auditor
    {
        ...
        private async Task<SqlConnection> OpenWithAzureCatalogFallbackAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                if (!SqlConnectionProfile.IsAzureSqlEndpoint(builder.DataSource) ||
                ...
                var connection = new SqlConnection(fallbackConnectionString);
                await connection.OpenAsync(cancellationToken);
...
WHERE d.name = DB_NAME();";
        ...
        public async Task<bool> TestAndNormalizeConnectionAsync()
        {
            ...
            try
            {
                ...
                if (SqlConnectionProfile.IsAzureSqlEndpoint(server))
                {
                    try
                    {
